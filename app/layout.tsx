...
import { Baloo_2 } from "next/font/google"; // Import Baloo or any other bubbly font
import "../assets/styles/globals.css";

const baloo = Baloo_2({ subsets: ["latin"], weight: "400" }); // Customize weight as needed
